...
# BACK UP
# questions = [("Is there ANY chance you could be pregnant? [y/n] ", "pregnant"),
#              ("Do you currently have a pacemaker/defibrillator? [y/n] ", "pacemaker"),
#              ("Have you ever had a pacemaker/defibrillator? [y/n] ", "past_pacemaker"),
#              ("Do you have a brain aneurysm clip? [y/n] ", "clip"),
#              ("Do you have a nerve or bone growth stimulator? [y/n] ", "stimulator"),
